...
void worker_thread_function (FIFORequestChannel* serverChan, BoundedBuffer* request, BoundedBuffer* response, int bufferSize) {
...
int main (int argc, char* argv[]) {
    ...
    for (int i = 0; i < w; i++){
        ...
        FIFORequestChannel* newChan = new FIFORequestChannel(channelName, FIFORequestChannel::CLIENT_SIDE); //[called dynamically, must delete]
